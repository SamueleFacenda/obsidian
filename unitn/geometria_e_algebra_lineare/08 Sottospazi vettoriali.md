...
Proposizione 3> Siano $v_1,\dots,v_m\in\Bbb R^n$ LI, con m<n, allora esistono n-m vettori di $\Bbb R^n$ $v_{m+1},\dots,v_n$ tali che $B\{v_1,\dots,v_m,v_{m+1},\dots,v_n\}$ sia base di $\Bbb R^n$
